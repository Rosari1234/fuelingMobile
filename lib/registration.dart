        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
                colors: [ Color.fromARGB(255, 250, 250, 250),Color.fromARGB(255, 250, 250, 250)],
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  CommonLogo(),
                  HeightBox(10),
                  "Create Your Account Now".text.size(22).black.make(),
                  TextField(
                  ...
                  HStack([
                    GestureDetector(
                      onTap: ()=>{
                        ...
                        child: VxBox(child: "Register".text.white.makeCentered().p16()).orange600.roundedLg.make().px16().py16(),
                    ),
                  ]),
                  GestureDetector(
                    onTap: (){
